...
public class Admin implements Serializable{
	...
	public void setManaerPw(String manaerPw) {
		this.manaerPw = manaerPw;
	}
	...
	public String toString() {
		return "Admin [mangerNo=" + mangerNo + ", mangerId=" + mangerId + ", manaerPw=" + manaerPw + ", userNo="
